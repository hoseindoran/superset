...
import TableCustomChartPlugin, {
  TableChartProps,
} from '@superset-ui/plugin-chart-table-custom';
import { basicFormData, basicData, birthNames } from './testData';
import { withResizableChartDemo } from '../../../shared/components/ResizableChartDemo';

export default {
  title: 'Chart Plugins/plugin-chart-table-custom',
  decorators: [withKnobs, withResizableChartDemo],
};

new TableCustomChartPlugin().configure({ key: 'table_custom' }).register();
